...
export function BrickBalloon({ animation = null, fadeDuration = 0.3, materialColor0 = 4, materialColor1 = 2, ...props }: BrickBalloonProps) {
      ...
      <group name={"BRICKBALLOON"} position={[0, 0.6, 0]}>
        <group name={"BRICK"} position={[0, -0.3, 0]}>
          ...
          <SplineElement
            ...
            curveType="catmullrom"
          />
          <C4DMesh name={nodes['Cube_color4'].name} geometry={nodes['Cube_color4'].geometry} castShadow receiveShadow>
