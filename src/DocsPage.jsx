...
export function DocsPage() {
    ...
    const htmlContent = useMemo(() => marked.parse(docsRaw), [])
    ...
    useEffect(() => {
        ...
        const headingEls = document.querySelectorAll('.docs-content h1, .docs-content h2, .docs-content h3')
        headingEls.forEach((el) => observer.observe(el))

        return () => observer.disconnect()
    }, [htmlContent])

    const handleNavClick = useCallback((e, slug) => {
        e.preventDefault()
