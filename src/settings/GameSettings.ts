...
export const SETTINGS: Settings = {
  ...
  installation: {
    watchdog: {
      ...
      idleSceneRenderCheckGraceMs: 90 * 1000,
      pageLoadSurvivalMs: 120 * 1000,
      ...
      canvasPixelHealthEnabled: true,
      canvasPixelSampleGridSize: 5,
      canvasPixelMinLumaRange: 12,
      canvasPixelMinLumaStdDev: 4,
      canvasPixelMinBottomLumaRange: 6,
      canvasPixelMinMeshesForCheck: 50,
      canvasPixelFrozenSampleStreak: 2,
      canvasPixelFrozenMinCameraDelta: 0.5,
    },
  },
