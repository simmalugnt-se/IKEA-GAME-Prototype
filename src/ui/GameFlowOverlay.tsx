    ...
    return (
      <div className="gfo-center-wrap">
        <div className="gfo-idle-prompt-wrap">
          ...
          <div className="popdot-text-base popdot-style-3 popdot-shadow-4 gfo-idle-prompt gfo-idle-prompt-sub gfo-vt-idle-prompt-sub"><span>One player at a time.</span><span>Stand in the spotlight.</span></div>
        </div>
      </div>
    )
  }
